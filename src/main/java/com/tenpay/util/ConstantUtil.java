...
public class ConstantUtil {
	...
	//��ʼ��
/*	public static String APP_ID = "wxc2ebb593810968f2";//΢�ſ���ƽ̨Ӧ��id
	public static String APP_SECRET = "a37ab8c87f4228d4f16426aa757fe6e3";//Ӧ�ö�Ӧ��ƾ֤
	//Ӧ�ö�Ӧ����Կ
	...
	*/
	...
	public static String PARTNER = "1358293402";//�Ƹ�ͨ�̻���
